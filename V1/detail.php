...
<html lang="zh-CN">
 ...
 $data2 = [
     "ConnectInformationList"=>["dataType"=>"scwsInformaitonList","ids"=>$ids,"game"=>$config['game'],"page"=>1,"page_size"=>6,"type"=>$return['information']['data']['type']!=4?"1,2,3,5,6,7":"4","fields"=>"*","expect_id"=>$id],
