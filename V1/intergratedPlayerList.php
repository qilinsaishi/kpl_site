...
<html lang="zh-CN">
 ...
 $info['page']['total_page'] = ceil($return['intergratedPlayerList']['count']/$info['page']['page_size']);
 ?>
<head>
<meta charset="UTF-8" />
  ...
  <div class="xs_lb">
    ...
    <div class="xs_nr">
      <ul class="row">
          ...
          {   ?>
              <li>
                  <div class="t_p"><a href="<?php echo $config['site_url']; ?>/player/<?php echo $playerInfo['pid'];?>" title="<?php echo $playerInfo['player_name'];?>">
