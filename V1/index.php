 ...
 $data = [
     ...
     "hotPlayerList"=>["dataType"=>"intergratedPlayerList","game"=>$config['game'],"page"=>1,"page_size"=>5,"fields"=>'pid,position,player_name,logo',"rand"=>1,"cacheWith"=>"currentPage","cache_time"=>86400*7],
