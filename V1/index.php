 ...
 $data = [
     ...
     "totalPlayerList"=>["game"=>$config['game'],"page"=>1,"page_size"=>5,"source"=>$config['source'],"fields"=>'player_id,position,player_name,logo,team_id',"rand"=>1,"cacheWith"=>"currentPage","cache_time"=>86400*7],
