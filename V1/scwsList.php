...
<html lang="zh-CN">
 ...
 $data = [
     "scwsKeyword"=>[$ids],
     "informationList"=>["dataType"=>"scwsInformaitonList","ids"=>$ids,"game"=>$config['game'],"page"=>$page,"page_size"=>$info['page']['page_size'],/*"type"=>$info['type']=="info"?"1,2,3,5,6,7":"4",*/"fields"=>"*"],
     ...
     //"informationList"=>["game"=>$config['game'],"page"=>$page,"page_size"=>$info['page']['page_size'],"type"=>$info['type']=="info"?"1,2,3,5,6,7":"4","fields"=>"*"],
